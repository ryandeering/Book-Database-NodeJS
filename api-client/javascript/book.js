    ...
    const rows = books.map(book => {
      ...
      // <tr> is a table row and <td> a table division represents a column
        ...
        if (userLoggedIn() === true) {      
            row+= `<td><button class="btn btn-xs" data-toggle="modal" data-target="#ProductFormDialog" onclick="prepareProductUpdate(${book.BookId})"><span class="oi oi-pencil"></span></button></td>
