...
const SQL_SELECT_ALL = 'SELECT * FROM dbo.Genre ORDER BY Genre ASC for json path;';

// for json path, without_array_wrapper - use for single json result
const SQL_SELECT_BY_ID = 'SELECT * FROM dbo.Genre WHERE GenreId = @id for json path, without_array_wrapper;';
